        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="flex flex-col gap-3">
            ...
            <input
              ...
              className="bg-accent/40 border border-border/40 px-5 py-4 text-base text-foreground placeholder:text-muted-foreground/30 focus:outline-none focus:border-primary transition-all duration-300 shadow-awesome1"
            />
          </div>
          <div className="flex flex-col gap-3">
            <label
