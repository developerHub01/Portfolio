...
const ContactInfo = () => {
  return (
    <div className="w-full h-full bg-secondaryColor flex flex-col p-2 rounded-md shadow-md shadow-secondaryColor text-whiteColor text-center divide-y-2 divide-whiteColor/50">
