            ...
            {CONTACT_METHODS.map(method => (
              ...
              >
                <FrameV1 className="opacity-0 group-hover/card:opacity-100">
                  <div className="bg-secondary/30 p-6 sm:p-8 flex items-center gap-5 shadow-awesome1 hover:bg-accent transition-all duration-300 h-full md:group-has-[:hover]/container:not-hover:blur-xs hover:blur-none border border-border/30">
